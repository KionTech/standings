    ...
    >
        ...
        >
            ...
            >
                ...
                <div
                    class="relative -mb-px flex aspect-335/376 w-full shrink-0 items-center justify-center overflow-hidden rounded-t-lg bg-[#1a1a2e] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg"
                >
                    <svg
                        class="w-32 text-white/10 opacity-100 transition-all duration-750 starting:translate-y-6 starting:opacity-0"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke="currentColor"
